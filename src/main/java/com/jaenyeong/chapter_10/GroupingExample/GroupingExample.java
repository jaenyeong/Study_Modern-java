package com.jaenyeong.chapter_10.GroupingExample;
...
import static com.jaenyeong.chapter_10.GroupingExample.Dish.menu;
import static com.jaenyeong.chapter_10.GroupingExample.GroupingBuilder.groupOn;
...
public class GroupingExample {
	...
	private static Map<Dish.Type, Map<CaloricLevel, List<Dish>>> groupDishedByTypeAndCaloricLevel3() {
		Collector<? super Dish, ?, Map<Dish.Type, Map<CaloricLevel, List<Dish>>>> c =
				groupOn((Dish dish) -> getCaloricLevel(dish)).after(Dish::getType).get();
